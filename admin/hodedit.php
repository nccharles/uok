...
<div id="container">
  <div class="content">
  <div id="box">
    <div class="box-top">EDIT HOD</div>
     <div class="box-panel">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
           ...
           <?php
          $id=$_GET['hid'];
          $sql = $con->prepare("SELECT * FROM department where hid=$id");
          $sql->execute();
          $rem=$sql->fetchAll();
          foreach ($rem as $row);
           $hid=$row['hid'];
      ...
      <input type="text" class="form-control" id="email" value="<?php echo $hid; ?>" name="hid" style="display: none">
     </div>
     <div class="form-group">
   ...
   <input type="submit" name="hsavec" class="btn btn-primary" value="SAVE CHANGES" />
   </form>
