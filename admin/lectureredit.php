...
<div id="container">
  <div class="content">
  <div id="box">
    <div class="box-top">EDIT LECTURER</div>
     <div class="box-panel">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
           ...
           <?php
          $id=$_GET['lid'];
          $sql = $con->prepare("SELECT * FROM lecture where lid=$id");
          $sql->execute();
          $rem=$sql->fetchAll();
          foreach ($rem as $row);
           $lid=$row['lid'];
      ...
      <input type="text" class="form-control" id="email" value="<?php echo $lid; ?>" name="lid" style="display: none">
     </div>
     <div class="form-group">
      <input type="text" pattern="[a-zA-Z ]{1,50}" title="Last Name should be letters" class="form-control" id="email" value="<?php echo $fname; ?>" name="fname" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" pattern="[0-9]{10}" title="Phone number must start with 078 or 073,072 Ex: 0781234567" id="email" placeholder="Ex: 078*******" name="phone" value="<?php echo $tel; ?>" required>
    </div>
   <input type="submit" name="lsavec" class="btn btn-primary" value="SAVE CHANGES" />
   </form>
